...
const userSignup = async (req, res) => {
  try {
    ...
    if (commingData.address) {
      addressMissingFields = requiredFieldsInAddress
        .filter((item) => {
          return (
            commingData.address[item] === undefined ||
    ...
    console.error(
      "Failed to handle registerController:",
      error
    );
...
const userLogin = async (req, res) => {
  try {
    ...
    const identifier = commingData.identifier.trim();
    ...
    console.log("RefreshToken cookie set successfully");
...
const refreshAccessToken = async (req, res) => {
  try {
    ...
    console.log(
      "Access and refresh tokens rotated successfully..."
    );
    ...
    console.error(
      "Failed to handle refreshAccessToken:",
      error
    );
